...
def test_histogram():
    assert [('0-9', [3, 7]), ('10-19', [10, 11, 12]), ('20-29', [20, 21, 22]), ('30-39', [31])] == util.iter.histogram([3, 7, 10, 11, 12, 20, 21, 22, 31], size=10, accumulate=True)
    assert [('0-9', 2), ('10-19', 3), ('20-29', 3), ('30-39', 1)] == util.iter.histogram([{'v': 3}, {'v': 7}, {'v': 10}, {'v': 11}, {'v': 12}, {'v': 20}, {'v': 21}, {'v': 22}, {'v': 31}], size=10, key=lambda x: x['v'])
    assert [('0-9', 2), ('10-19', 3), ('20-29', 3), ('30-39', 1)] == util.iter.histogram([3, 7, 10, 11, 12, 20, 21, 22, 31], size=10)
    assert [('0-9', 2), ('10-29', 6), ('30-39', 1)] == util.iter.histogram([3, 7, 10, 11, 12, 20, 21, 22, 31], size=10, exponential=True)
    assert [('0-9', 3), ('10-29', 6), ('30-39', 1)] == util.iter.histogram([0, 3, 7, 10, 11, 12, 20, 21, 22, 31], size=10, exponential=True)
